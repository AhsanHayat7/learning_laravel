                  ...
                  <tbody class="border-0">
                    <tr>
                      <th class="ps-0 py-3 border-light" scope="row">
                        <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href="{{url('/product-details')}}"><img src="{{url('frontend/img/product-detail-3.jpg')}}" alt="..." width="70"/></a>
                    ...
                    <tr>
                      <th class="ps-0 py-3 border-0" scope="row">
                        <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href="{{url('/product-details')}}"><img src="{{url('frontend/img/product-detail-2.jpg')}}" alt="..." width="70"/></a>
