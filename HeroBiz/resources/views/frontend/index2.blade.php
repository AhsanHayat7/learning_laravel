        ...
        <div class="container">
          <div class="row justify-content-center gy-6">
            ...
            <div class="col-lg-5 col-md-8">
              <img src="{{url('frontend/assets/img/hero-carousel/hero-carousel-1.svg')}}" alt="" class="img-fluid img">
            </div>
      ...
      <div class="carousel-item">
        <div class="container">
          <div class="row justify-content-center gy-6">
            ...
            <div class="col-lg-5 col-md-8">
              <img src="{{url('frontend/assets/img/hero-carousel/hero-carousel-2.svg')}}" alt="" class="img-fluid img">
            </div>
      ...
      <div class="carousel-item">
        <div class="container">
          <div class="row justify-content-center gy-6">
            ...
            <div class="col-lg-5 col-md-8">
              <img src="{{url('frontend/assets/img/hero-carousel/hero-carousel-3.svg')}}" alt="" class="img-fluid img">
            </div>
